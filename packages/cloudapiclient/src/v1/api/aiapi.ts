...
export const AIApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async extractTransactions(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExtractTransactions200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.extractTransactions(
        file,
        startDate,
        options,
      )
      ...
      const localVarOperationServerBasePath =
        operationServerMap['AIApi.extractTransactions']?.[localVarOperationServerIndex]?.url
...
export const AIApiFactory = function (
  ...
  return {
    ...
    extractTransactions(
      ...
      startDate?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ExtractTransactions200Response> {
      return localVarFp
        .extractTransactions(file, startDate, options)
