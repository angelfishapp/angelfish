...
export const CurrenciesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getCurrencyLatestRates: async (currencies: Array<CurrencyCodes>, base?: CurrencyCodes, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getCurrencyRates: async (currency: CurrencyCodes, startDate: string, endDate?: string, base?: CurrencyCodes, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v1/currencies/{currency}`
...
export const CurrenciesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getCurrencyLatestRates(currencies: Array<CurrencyCodes>, base?: CurrencyCodes, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LatestCurrencyExchangeRates>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCurrencyLatestRates(currencies, base, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CurrenciesApi.getCurrencyLatestRates']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getCurrencyRates(currency: CurrencyCodes, startDate: string, endDate?: string, base?: CurrencyCodes, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HistoricalCurrencyExchangeRates>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCurrencyRates(currency, startDate, endDate, base, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CurrenciesApi.getCurrencyRates']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const CurrenciesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getCurrencyLatestRates(currencies: Array<CurrencyCodes>, base?: CurrencyCodes, options?: RawAxiosRequestConfig): AxiosPromise<LatestCurrencyExchangeRates> {
            return localVarFp.getCurrencyLatestRates(currencies, base, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get all the Exchange Rates for a Currency from START_DATE to END_DATE
         ...
         * @throws {RequiredError}
         */
        getCurrencyRates(currency: CurrencyCodes, startDate: string, endDate?: string, base?: CurrencyCodes, options?: RawAxiosRequestConfig): AxiosPromise<HistoricalCurrencyExchangeRates> {
            return localVarFp.getCurrencyRates(currency, startDate, endDate, base, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class CurrenciesApi extends BaseAPI {
     ...
     * @memberof CurrenciesApi
     */
    public getCurrencyLatestRates(currencies: Array<CurrencyCodes>, base?: CurrencyCodes, options?: RawAxiosRequestConfig) {
        return CurrenciesApiFp(this.configuration).getCurrencyLatestRates(currencies, base, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CurrenciesApi
     */
    public getCurrencyRates(currency: CurrencyCodes, startDate: string, endDate?: string, base?: CurrencyCodes, options?: RawAxiosRequestConfig) {
        return CurrenciesApiFp(this.configuration).getCurrencyRates(currency, startDate, endDate, base, options).then((request) => request(this.axios, this.basePath));
    }
}
