...
export interface ProcessWindowOptions {
  ...
  directIPCChannel?: boolean
  /**
   * If true, all requests from this window will be sent with the User-Agent header generated by Angelfish
   * to identify the application and the current machine and its settings. This is useful for security (identifying
   * a new device logging in) and for analytics to better understand the usage of the application.
   * @default false
   */
